...
and #69 are complete at the REM-001 checkpoint, #61 is the serialized central-World
producer owner, and #64 is the separable graph/index lane. Stage 4 is not admitted.
