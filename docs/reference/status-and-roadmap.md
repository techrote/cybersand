...
**Current research checkpoint:** [cell layout experiments](../operations/cell-layout-experiment.md) complete L1/L2/L3/L4's196/448/280/1400 registered processes on an isolated branch. Exact scoped comparisons pass. Padded sleeping costs, shorter-epoch tails and active sidecar costs remain negative/ambiguous evidence. L5 records ID/state compatibility; L6 is not admitted with supporting geometry/capacity evidence. G-L research evidence is complete locally, with no production layout, epoch, ID or scheduler decision. See [final results and gaps](../audits/2026-09-10-issue-16-cell-layout.md#l4-measured-results-and-final-g-l-september11).
