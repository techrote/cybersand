...
**Current research checkpoint:** [cell layout experiments](../operations/cell-layout-experiment.md) completed L1's196-process original4/padded8 campaign on an isolated branch. Exact comparisons pass; sleeping p95/wrap-tail costs trigger review. L2 completed448 packing/bridge/observer processes with exact comparisons and cost flags. L3 completes280 epoch/bridge/observer processes; six-bit epochs increase sleeping p99 about4x. The neutral sidecar now passes corrected correctness/replay checks; its timing remains pending and G-L stays open. No layout is selected. See [dated results](../audits/2026-09-10-issue-16-cell-layout.md#l2-measured-results-september11).
