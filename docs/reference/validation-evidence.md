...
The [September10–11 record](../audits/2026-09-10-issue-16-cell-layout.md) owns isolated source/artifact identities, native correctness and the completed196-process L1 and448-process L2 campaigns. Exact state/work and final Water/Sand accounting pass; sleeping p95 and wrap-tick proxies flag costs. Packing/bridge/observer pairs and worker/repeat checks pass; three individual packing pairs cross15%, with no primary median above it. L3 preparation passes165 native checks,52,428,800 storage mappings,80 extended behavior/movement runs,eight observer-off checks and20 setup checks. L3 completes280 processes with exact comparisons,32 versus8 clears and about8.4ms direct sleeping clears. L4 passes720 corrected runs,12 absent/unread smoke runs and60 independent replays; sidecar timing remains pending. No desktop/Web or production acceptance is implied; G-L is incomplete.
