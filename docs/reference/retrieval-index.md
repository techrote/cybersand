...
## Which fixture can I run interactively and headlessly, and is its capture a replay?

Use the [MicroScenario contract](../operations/micro-scenario-harness.md) for schema,
shared owner/reset behavior, launcher and headless commands, finite event budgets,
identity-rich observations and explicit incomplete-replay limits. Platform evidence
belongs to the [MS-000 audit](../audits/2026-09-19-ms000-harness.md).
